...
```sh
pip install git+https://github.com/gavk/eve_swagger_api.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/gavk/eve_swagger_api.git`)
...
api_instance = eve_swagger_api.AllianceApi(eve_swagger_api.ApiClient(configuration))
